...
- [ ] 1. Definir excepciones de dominio, interfaz IPacService y DTOs
  - [ ] 1.1 Crear la jerarquía de excepciones PAC en Infrastructure
  ...
  - [ ] 1.2 Crear la interfaz IPacService y los DTOs de resultado en Application
  ...
  - [ ] 1.3 Crear la interfaz IEmisorCredencialesProvider en Application
...
- [ ] 2. Implementar Commands, Queries y Validators
  - [ ] 2.1 Crear TimbrarCfdiCommand y su Validator
  ...
  - [ ] 2.2 Crear CancelarCfdiCommand y su Validator
  ...
  - [ ] 2.3 Crear ConsultarEstatusCfdiQuery y su Validator
  ...
  - [ ]* 2.4 Write property tests for validators (Properties 2, 3)
...
- [ ] 3. Implementar Handlers
  - [ ] 3.1 Crear TimbrarCfdiCommandHandler
  ...
  - [ ] 3.2 Crear CancelarCfdiCommandHandler
  ...
  - [ ] 3.3 Crear ConsultarEstatusCfdiQueryHandler
  ...
  - [ ]* 3.4 Write unit tests for handlers
...
- [ ] 4. Checkpoint - Validar capa de Application
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implementar configuración y credenciales del emisor
  - [ ] 5.1 Crear clases de configuración PacOptions y EmisoresOptions
  ...
  - [ ] 5.2 Implementar FileSystemEmisorCredencialesProvider
  ...
  - [ ]* 5.3 Write unit tests for FileSystemEmisorCredencialesProvider
...
- [ ] 6. Implementar PacServiceFactory y PacResilienceDecorator
  - [ ] 6.1 Crear PacServiceFactory
  ...
  - [ ] 6.2 Crear PacResilienceDecorator
  ...
  - [ ]* 6.3 Write property tests for PacResilienceDecorator (Properties 4, 5)
  ...
  - [ ]* 6.4 Write property test for PacServiceFactory (Property 6)
...
- [ ] 7. Implementar adaptador MultifacturasPacAdapter
  - [ ] 7.1 Crear MultifacturasPacAdapter
  ...
  - [ ]* 7.2 Write integration tests for MultifacturasPacAdapter con WireMock
  ...
  - [ ]* 7.3 Write property test for timbrado response parsing (Property 1)
...
- [ ] 9. Implementar MCP Tools y registro de DI
  - [ ] 9.1 Crear MCP Tools para PAC
  ...
  - [ ] 9.2 Crear extensión AddPacServices para DI
  ...
  - [ ] 9.3 Integrar AddPacServices en Program.cs
  ...
  - [ ]* 9.4 Write unit tests for MCP Tools
...
- [ ] 10. Observabilidad y seguridad
  - [ ] 10.1 Agregar logging estructurado y métricas a las llamadas PAC
  ...
  - [ ]* 10.2 Write property test for credential scrubbing in logs (Property 7)
